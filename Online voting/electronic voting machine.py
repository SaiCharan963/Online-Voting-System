...
def rating():
    ...
    webbrowser.open('https://en.wikipedia.org/wiki/Electronic_voting_in_India')
...
def win2():
    ...
    frame1 = tk.Frame(win2.window2, width=400, height=600, bg="orange")
    frame1.pack()

    label1 = tk.Label(win2.window2, text="V.V.P.A.T",width=14, relief=RIDGE, bg="green", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win2.window2, width=400, height=50, bg="red")
    frame2.place(x=0, y=80)
    btn1 = tk.Button(frame2, text="Know More", width=10, relief=RAISED, borderwidth=5, bg="violet",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="violet")
    btn2.config(font=('Arial bold', 10))
    btn2.grid(row=0, column=2, padx=20)
    btn3 = tk.Button(frame2, text="Exit(X)", width=10, relief=RAISED, borderwidth=5, bg="violet",command=exit1)
    btn3.config(font=('Arial bold', 10))
    btn3.grid(row=0, column=3, padx=20)

    frame3 = tk.Frame(win2.window2, width=400, height=400,relief=FLAT,borderwidth=9, bg="pink")
    frame3.place(x=0, y=133)
    btn4 = tk.Button(frame3, text="START\nVOTING", width=18, relief=RAISED, borderwidth=5, bg="grey",command=win3)
...
def win3():
    ...
    frame1 = tk.Frame(win3.window3, width=400, height=600, bg="red")
    frame1.pack()

    label1 = tk.Label(win3.window3, text="V.V.P.A.T",width=14, relief=RIDGE, bg="green", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win3.window3, width=400, height=50, bg="black")
    frame2.place(x=0, y=60)
    btn1 = tk.Button(frame2, text="Know More", width=10, relief=RAISED, borderwidth=5, bg="violet",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="violet",command=reset1)
    btn2.config(font=('Arial bold', 10))
    btn2.grid(row=0, column=2, padx=20)
    btn3 = tk.Button(frame2, text="Exit(X)", width=10, relief=RAISED, borderwidth=5, bg="violet",command=exit1)
    btn3.config(font=('Arial bold', 10))
    ...
    frame5 = tk.Frame(win3.window3, width=400, height=400, relief=FLAT, borderwidth=9, bg="brown")
    frame5.place(x=32, y=100)

    btn7 = tk.Button(frame5, text="B.J.P", width=20, relief=RAISED, borderwidth=5, bg="silver", command=bjp)
    btn7.config(font=('Arial bold', 17))
    btn7.grid(row=0, column=0, padx=12, pady=2)
    btn8 = tk.Button(frame5, text="R.L.D", width=20, relief=RAISED, borderwidth=5, bg="silver", command=rld)
    btn8.config(font=('Arial bold', 17))
    btn8.grid(row=1, column=0, padx=12, pady=2)
    btn9 = tk.Button(frame5, text="A.A.P", width=20, relief=RAISED, borderwidth=5, bg="silver", command=aap)
    btn9.config(font=('Arial bold', 17))
    btn9.grid(row=2, column=0, padx=12, pady=2)
    btn10 = tk.Button(frame5, text="B.S.P", width=20, relief=RAISED, borderwidth=5, bg="silver", command=bsp)
    btn10.config(font=('Arial bold', 17))
    btn10.grid(row=3, column=0, padx=12, pady=2)
    btn11 = tk.Button(frame5, text="T.R.S", width=20, relief=RAISED, borderwidth=5, bg="silver", command=trs)
    ...
    btn4 = tk.Button(frame4, text="NEXT(>>)", width=8, relief=RAISED, borderwidth=5, bg="violet",command=next1)
    btn4.config(font=('Arial bold', 15))
    btn4.grid(row=0, column=0, padx=100,pady=5)
    btn5 = tk.Button(frame4, text="RESULT", width=8, relief=RAISED, borderwidth=5, bg="violet",command=result)
    btn5.config(font=('Arial bold', 15))
    btn5.grid(row=1, column=0, padx=100,pady=5)
    btn6 = tk.Button(frame4, text="Your Vote", width=8, relief=RAISED, borderwidth=5, bg="violet",command=history)
...
def win4():
    ...
    label7 = tk.Label(frame5, text=a1, width=24, relief=RIDGE, borderwidth=5, bg="white")
    label7.config(font=('Arial bold', 15))
    label7.grid(row=0, column=0, padx=12, pady=6)
    label8 = tk.Label(frame5, text=a2, width=24, relief=RIDGE, borderwidth=5, bg="white")
    ...
    label11 = tk.Label(frame5, text=a5, width=24, relief=RIDGE, borderwidth=5, bg="white")
